...
| media              | For MMS messages, a media url to the location of the media or list of medias to be sent send with the message. <br> Check the [faq](http://dev.bandwidth.com/faq/messaging/mediaType.html) to see what media types are supported. <br> <br> **Check the [faq](http://dev.bandwidth.com/faq/messaging/tollfreeMMS.html) to learn more about Toll-Free MMS**                                                                                                                                                   | No        |
